...
<?php $component = $__env->getContainer()->make(App\View\Components\LogInput::class, ['type' => 'text','name' => 'name','label' => 'Имя пользователя','placeholder' => 'name']); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalbdfbd22e2e58b50adcb6c096444b9fae89a23f1e = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\LogInput::class, ['type' => 'password','name' => 'password','label' => 'Пароль','placeholder' => 'Password']); ?>
<?php $component->withName('log-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalbdfbd22e2e58b50adcb6c096444b9fae89a23f1e = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\LogInput::class, ['type' => 'password','name' => 'conf_password','label' => 'Подтверждение пароля','placeholder' => 'Password']); ?>
<?php $component->withName('log-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
                ...
                <hr class="4">
                <small class="text-muted">У вас уже есть аккаунт? <a href="<?php echo e(route('UserLoginForm')); ?>">Вход</a></small>
            </form>
        </div>
    </div>
</div>
...
<?php /**PATH C:\OSPanel\domains\r\resources\views/User/UserSignUp.blade.php ENDPATH**/ ?>